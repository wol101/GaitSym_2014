...
void
GLUtils::DrawCylinder(dVector3 p, dMatrix3 R, double length, double radius, Colour &colour, double ox, double oy, double oz)
{
    const static int kSides = 128;
...
void GLUtils::DrawPath(pgd::Vector *pathCoordinates, int numPathCoordinates, double radius, Colour &colour)
{
    if (radius == 0)
    {
        glDisable(GL_LIGHTING);
